...
let canUseCTWatch = true;
if (windowLocation.includes("disable_ct")) {
	canUseCTWatch = false;
}
if (canUseCTWatch == true) {
	...
	if (BTConfig.videoPlayerSize == "PS1600x900") {
		playerSize.width = 1600;
		playerSize.height = 900;
		document.querySelector("html").setAttribute("player-width", "1600");
		document.querySelector("html").setAttribute("player-height", "900");
	}
	if (BTConfig.videoPlayerSize == "PS1920x1080") {
		playerSize.width = 1920;
		playerSize.height = 1080;
		document.querySelector("html").setAttribute("player-width", "1920");
		document.querySelector("html").setAttribute("player-height", "1080");
	}
	...
	*/
	...
	function getInitialVariables() {
		document.querySelector("html").setAttribute("ct","");
		...
		function getLayout() {
			...
			if (BTConfig.layoutSelect == "amsterdam-2022") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch11");
			}
			if (BTConfig.layoutSelect == "polymer-2022") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch10classic");
			}
			if (BTConfig.layoutSelect == "polymer-2021") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch9b");
			}
			if (BTConfig.layoutSelect == "polymer-2020") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch9b");
				document.querySelector("html").setAttribute("use-sidebar-autoplay", "");
			}
			if (BTConfig.layoutSelect == "polymer-2019") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch9a");
				document.querySelector("html").setAttribute("use-sidebar-autoplay", "");
			}
			if (BTConfig.layoutSelect == "hitchhiker-2017") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch8");
				document.querySelector("html").setAttribute("use-sidebar-autoplay", "");
			}
			...
			if (BTConfig.layoutSelect == "hitchhiker-2014") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch7");
			}
			...
			if (BTConfig.layoutSelect == "cosmicpanda-3") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch5d");
			}
			if (BTConfig.layoutSelect == "aozora-2011") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch5c");
			}
			if (BTConfig.layoutSelect == "stargazer-2009-3") {
				...
				document.querySelector("html").setAttribute("watch-version", "watch4");
				document.querySelector("html").setAttribute("use-side-watch-metadata", "");
			}
		...
		function getHPVPR() {
			...
			if (
				BTConfig.homepageType == "HPTypeShelves"
			) {
				document.querySelector("html").setAttribute("homepage", "shelves");
			}
			if (
				BTConfig.homepageType == "HPTypeGrid"
			) {
				if (
					BTConfig.layoutSelect == "amsterdam-2022" ||
		...
		function getRelatedVideos() {
			...
			if (BTConfig.relatedHeader == "RHautoplay") {
				document.querySelector("html").setAttribute("use-sidebar-autoplay", "large");
			}
		}
		function getTFI() {
		...
		function getWM() {
			if (BTConfig.watchMetadata == "WMdisabled") {
				document.querySelector("html").setAttribute("watch-version", "current");
			}
			if (BTConfig.watchMetadata == "WMwatch4A") {
				document.querySelector("html").setAttribute("watch-version", "watch4");
				document.querySelector("html").setAttribute("use-side-watch-metadata", "");
			}
			if (BTConfig.watchMetadata == "WMwatch5C") {
				document.querySelector("html").setAttribute("watch-version", "watch5c");
			}
			if (BTConfig.watchMetadata == "WMwatch5D") {
				document.querySelector("html").setAttribute("watch-version", "watch5d");
			}
			if (BTConfig.watchMetadata == "WMwatch7") {
				document.querySelector("html").setAttribute("watch-version", "watch7");
			}
			if (BTConfig.watchMetadata == "WMwatch8") {
				document.querySelector("html").setAttribute("watch-version", "watch8");
			}
			if (BTConfig.watchMetadata == "WMaltWatch9") {
				document.querySelector("html").setAttribute("watch-version", "alt-watch9");
			}
			if (BTConfig.watchMetadata == "WMwatch9A") {
				document.querySelector("html").setAttribute("watch-version", "watch9a");
			}
			if (BTConfig.watchMetadata == "WMwatch9B") {
				document.querySelector("html").setAttribute("watch-version", "watch9b");
			}
		}
	}
	...
	let watchScript = document.createElement('script');
	watchScript.src = browser.runtime.getURL('/scripts/emerald.js');
	document.body.append(watchScript);


	document.addEventListener("yt-page-data-fetched", getHref); 
} else {
		...
		if (canGo != false) {
			...
			<div id="nebula-return-banner-inner">
				<div id="nebula-return-banner-text">
					<span>CustomTube is temporarily disabled.</span>
				</div>
				<button id="nebula-return-banner-button">
